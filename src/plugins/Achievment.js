...
class Achievment {
  ...
  async build() {
    ...
    canvas.GlobalFonts.registerFromPath(
      join(__dirname, '..', '/', 'fonts', 'AvenirNextLTPro-Bold.otf'),
      'FontBold'
    );
    canvas.GlobalFonts.registerFromPath(
      join(__dirname, '..', '/', 'fonts', 'AvenirNextLTPro-Regular.otf'),
      'FontRegular'
    );
    ...
    const image = await canvas.loadImage(
      'https://cdn.discordapp.com/attachments/1047187283234795580/1053677610367975624/Track_View.png'
    );
